...
Для початку зареєструмося на [wix.com](https://uk.wix.com), можна через обліковий запис на Facebook або Google. Щоб створити сайт, перейдіть за посиланням на порожнiй шаблон, звідси ми потрапляємо прямісінько в редактор.
